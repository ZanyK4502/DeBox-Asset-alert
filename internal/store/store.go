...
var (
	...
	ErrInvalidNotificationSnapshot = errors.New("invalid notification detail snapshot")
	...
	ErrMarketCombinationExists     = errors.New("market combination already exists")
	ErrMarketCombinationNotPaused  = errors.New("only paused market combinations can be deleted")
	ErrMarketRuleExists            = errors.New("market rule already exists")
